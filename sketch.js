...
function setup() {
 ...
 //console.log(canvasSize);
  ...
  trex = createSprite(displayWidth - 1300,displayHeight - 1000,displayWidth - 200,displayHeight - 500);
...
function draw() {
  ...
  if(gameState === PLAY){
    ...
    if(keyDown("space")&& trex.y >= displayHeight - 225) {
        trex.velocityY = -12;
        jumpSound.play();
    }
...
function spawnObstacles(){
 if (frameCount % 60 === 0){
   var obstacle = createSprite(displayWidth,displayHeight - 205,10,40);
